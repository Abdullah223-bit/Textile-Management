...
export default function ProductDetailPage() {
  ...
  const productNumber = searchParams?.get("number") || "N/A";
      ...
      >
        <div className="bg-white/60 backdrop-blur-lg rounded-3xl shadow-2xl p-10 max-w-5xl w-full border border-white/50 transition-all duration-300">
          <button
            ...
            className="inline-flex items-center mb-8 px-5 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-semibold shadow-md transition"
          >
            ← Back to Products
          </button>
            ...
            <div className="flex flex-col justify-between">
              <div>
                <p className="text-xl text-purple-600 font-medium mb-1">
                  Product Number: <span className="text-gray-900">{productNumber}</span>
                </p>
