      ...
      >
        <div className="bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-2xl max-w-4xl w-full text-center border border-white/50">
          ...
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            The <span className="font-semibold text-purple-700">Yarn Manufacturing Inventory System</span> is designed specifically for the textile industry to manage yarn stock efficiently, maintain product records, and ensure smooth operational flow in yarn production and inventory control.
          </p>

          <div className="text-left space-y-6 text-gray-800 font-medium">
            <div>
              <h2 className="text-xl font-bold text-purple-700 mb-1">🔍 Key Features:</h2>
            ...
            <div>
              ...
              <p>
                Small to medium-sized textile manufacturing companies looking to digitize their inventory process and reduce manual record keeping.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                This system is developed using <span className="font-semibold">React, Next.js, Tailwind CSS,</span> and <span className="font-semibold">MongoDB</span> for efficient and scalable performance.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                This project is developed with passion and precision to support the evolving needs of textile inventory management.
              </p>
            </div>
          </div>
        </div>
