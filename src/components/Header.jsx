    ...
    <header className="sticky top-0 z-50 bg-gradient-to-r from-purple-700 via-blue-700 to-indigo-700 shadow-lg">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8 font-semibold text-white text-lg">
          <Link href="/home" className="hover:text-yellow-300 transition duration-300">
            Home
          </Link>
          <Link href="/add-product" className="hover:text-yellow-300 transition duration-300">
            Add Product
          </Link>
          <Link href="/all-products" className="hover:text-yellow-300 transition duration-300">
            Product Details
          </Link>
          <Link href="/about" className="hover:text-yellow-300 transition duration-300">
            About
          </Link>
          <Link href="/listing" className="hover:text-yellow-300 transition duration-300">
            All Records
          </Link>
        </nav>
      ...
      >
        <nav className="flex flex-col space-y-3 px-6">
          {[
            ...
            { label: "Product Details", href: "/all-products" },
            { label: "About", href: "/about" },
            { label: "All Records", href: "/listing" },
          ].map(({ label, href }) => (
            <Link
              key={href}
              href={href}
